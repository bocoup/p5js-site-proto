...
descriptionText: >-
  ...
  information necessary for rendering a 3D scene.New p5.Camera objects can be
  made through the
  ...
  can be set through the <a href="#/p5/setCamera">setCamera()</a> method.Note:
  ...
  method sets the camera's position in world-space.The camera object propreties
