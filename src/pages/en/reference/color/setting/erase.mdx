...
descriptionText: >-
  ...
  (full strength).The second parameter sets the strength of erasing by the
  shape's edge. A
  ...
  255 (full strength).To cancel the erasing effect, use the <a
  href="#/p5/noErase">noErase()</a>
