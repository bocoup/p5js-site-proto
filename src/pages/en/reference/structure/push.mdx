...
descriptionText: >-
  ...
  control. (See the second example for a demonstration.)<a
  href="#/p5/push">push()</a> stores information related to the current
  ...
  <a href="#/p5/noiseSeed">noiseSeed()</a>.In WEBGL mode additional style
  settings are stored. These are controlled by the
  ...
  <a href="#/p5/pointLight">pointLight()</a>, <a
  href="#/p5/texture">texture()</a>,
