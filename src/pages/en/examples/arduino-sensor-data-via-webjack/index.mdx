...
description: >-
  ...
  Note: WebJack and p5-webjack libraries must be added to your index.html as
  follows:

  <pre><code class="language-markup">&lt;script
  src="https://webjack.io/dist/webjack.js">&lt;/script></code></pre>

  <pre><code class="language-markup">&lt;script
  src="https://jywarren.github.io/p5-webjack/lib.js">&lt;/script></code></pre>
  ...
  Arduino will output audio from pin 3 + ground. Use microphone or an audio
  cable.
---
