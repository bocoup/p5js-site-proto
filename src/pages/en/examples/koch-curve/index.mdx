...
code: >
  ...
  // Includes methods to calculate midp5.Vectors along the line according to the
  Koch algorithm
...
description: >-
  Renders a simple fractal, the Koch snowflake. Each recursive level is drawn in
  sequence.
